...
namespace Gsstwpfmock.ViewModel
{
    public partial class AdminDashboardViewModel : ObservableObject
    {
        ...
        public AdminDashboardViewModel(IServiceProvider serviceProvider, IStatisticsService statisticsService, IUserService usersService, SettingsService settingsService, ITanksService tanksService, IPumpService pumpService, IGoodsService goodsService, IFuelTypeService fuelTypeService, IReportService reportService, IOrderService orderService)
        {
            ...
            var userSession = Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<UserSession>(_serviceProvider);
            IsAdmin = userSession.SessionUser?.Role == UserRoles.Admin;
            IsManager = userSession.SessionUser?.Role == UserRoles.Manager || IsAdmin;
        ...
        [ObservableProperty]
        private ObservableCollection<PaymentMethod> _selectedUserPaymentMethods;
        ...
        partial void OnSelectedUserChanged(User value)
        {
            if (value != null)
            {
                ...
                SelectedUserPaymentMethods = new ObservableCollection<PaymentMethod>(paymentService.GetPaymentMethodsForUser(value.Id));
            }
            else
            {
                SelectedUserPaymentMethods = new ObservableCollection<PaymentMethod>();
            }
        }
